// homebridge-ws/lib/WsAccessoryOpenWeatherMap.js
...
const WsService = require('./WsServiceOpenWeatherMap')

module.exports = class WsAccessoryOpenWeatherMap extends homebridgeLib.AccessoryDelegate {
  constructor (platform, context) {
    const params = {
      name: context.location,
      id: 'WS-OWM-' + context.location.toUpperCase().replace(/[^A-Z0-9]/g, ''),
