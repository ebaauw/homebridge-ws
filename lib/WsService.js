...
function toWeekDay (dt) {
  return weekDays[new Date(moment.unix(dt)).getDay()]
}
...
class Weather extends WsService {
  ...
  checkObservation (observation) {
    ...
    this.values.windSpeed = Math.round(o.wind_speed * 36) / 10
