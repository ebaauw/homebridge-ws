...
module.exports = class WSPlatform extends homebridgeLib.LibPlatform {
  constructor (log, configJson, homebridge) {
    ...
    this.eve = new homebridgeHueUtils.EveHomeKitTypes(homebridge)
    this.my = new homebridgeHueUtils.MyHomeKitTypes(homebridge)
    this.wunderground = new homebridgeHueUtils.RestClient({
